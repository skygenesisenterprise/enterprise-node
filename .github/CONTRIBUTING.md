...
# Contributing to Enterprise Node SDK

Thank you for your interest in contributing to **Enterprise Node SDK**!  
...
**Enterprise Node SDK** is the official Enterprise Node SDK of Sky Genesis Enterprise, licensed under **MIT Licence**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/enterprise-node/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/enterprise-node/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to Enterprise Node SDK! 💌
