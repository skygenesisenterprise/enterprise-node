# Commercial Use of Enterprise Node SDK

Enterprise Node SDK is released under the **MIT Licence** [LICENCE](LICENSE)
...
- Offer Enterprise Node SDK as a paid or free SaaS (Software-as-a-Service) product.
- Bundle Enterprise Node SDK into a commercial product or platform.
- Use Enterprise Node SDK in a business context without open-sourcing your modifications and dependencies (as required by MIT Licence).
...
**Note:** Using Enterprise Node SDK in a commercial environment **without respecting the MIT Licence terms or without a commercial license** may constitute a license violation.
