...
Thank you for using **Enterprise Node SDK** — the official Enterprise Node SDK developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Enterprise Node SDK and need help with:
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/enterprise-node/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/enterprise-node/issues) – for bug reports only
...
If you are using Enterprise Node SDK in a professional or production environment and require:
...
Want to help improve for the Enterprise Node SDK?  
