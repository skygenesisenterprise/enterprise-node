...
export function useEnterprise(options = {}) {
...
export function useAi() {
    ...
    const enhance = useCallback(async (image) => {
...
export function useProject() {
    ...
    const create = useCallback(async (name, options) => {
        if (!isInitialized || !enterprise) {
            throw new Error('Enterprise not initialized');
        }
        return await enterprise.project.create(name, options);
    }, [enterprise, isInitialized]);
    const open = useCallback(async (projectIdOrName) => {
        if (!isInitialized || !enterprise) {
            throw new Error('Enterprise not initialized');
        }
...
export function useUi() {
    const { enterprise, isInitialized } = useEnterprise();
    const notify = useCallback(async (message, options) => {
        if (!isInitialized || !enterprise) {
    ...
    const modal = useCallback(async (options) => {
        if (!isInitialized || !enterprise) {
